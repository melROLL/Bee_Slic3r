...
{
    m_entries = {
        { "WaspSlicer"     , "2022 WaspSlicer"                            , "https://github.com/melROLL/Prosciutto_Slic3r" },
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO/*NEVER*/);
    {
        ...
        const std::string contributors_str = _utf8(L("Contributions by Melvyn ROLLAND, Leonardo and numerous others."));
        const std::string manual_str = _utf8(L("Inspired by the RepRap community."));
