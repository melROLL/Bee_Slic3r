...
private:
    ...
    struct ConstantText
    {
        ...
        void init(wxFont init_font)
        {
            ...
            // credits infornation
            credits = _L("WaspSlicer is based on SuperSlicer is a skinned version of Slic3r, based on PrusaSlicer by Prusa and the original Slic3r by Alessandro Ranellucci & the RepRap community.") + "\n\n" +
                        title + " " + _L("is licensed under the") + " " + _L("GNU Affero General Public License, version 3") + "\n\n" +
                        _L("Contributions by Melvyn ROLLAND.");
